...
Swap a face in a target image using a source face image. The API guide documents the target/source inputs and optional face index.

[Muapi Image Face Swap API landing page](https://muapi.ai/image-face-swap-api) · [API reference](https://muapi.ai/docs/api-reference) · [Create an API key](https://muapi.ai/access-keys)
...
|---|---|---|
| `ai-image-face-swap` | Image Faceswap | `Image to Image` |
...
curl -X POST https://api.muapi.ai/api/v1/ai-image-face-swap \
  ...
  -d '{
    ...
    "swap_url": "https://example.com/replace-with-your-file"
  }'
```
...
|---|---|---|
| `image_url` | Required | Target URL of the input image. Image width and height cannot be greater than 2048px |
| `swap_url` | Required | Swap URL of the input image. Image width and height cannot be greater than 2048px |
...
- [Muapi Image Face Swap API](https://muapi.ai/image-face-swap-api)
